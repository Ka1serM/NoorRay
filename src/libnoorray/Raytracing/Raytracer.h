...
private:
    ...
    noorrhi::Shader raygenShader;
    noorrhi::Shader missShader;
    noorrhi::Shader hitShader;
    noorrhi::Shader emissionHitShader;
    noorrhi::Shader opacityAnyHitShader;
    noorrhi::Shader gaussianAnyHitShader;
    noorrhi::Shader gaussianHitShader;
