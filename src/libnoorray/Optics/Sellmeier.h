...
inline constexpr float FraunhoferRedNm = 656.2725f;
inline constexpr float FraunhoferGreenNm = 546.0740f;
inline constexpr float FraunhoferBlueNm = 486.1327f;
...
inline glm::vec3 sellmeierFraunhoferIors(
