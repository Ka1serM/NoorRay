...
// Shading/OpenPbrEnergyTables/ and are Apache-2.0 licensed. Keeping the
...
#include "Shading/OpenPbrEnergyTables/openpbr_opaque_dielectric_energy_complement_data.h"
};

static constexpr uint16_t OpaqueDielectricAverageEnergyComplement[
    EnergyTableSize * EnergyTableSize] = {
#include "Shading/OpenPbrEnergyTables/openpbr_opaque_dielectric_avg_energy_complement_data.h"
};

static constexpr uint16_t IdealDielectricEnergyComplement[
    EnergyTableSize * EnergyTableSize * EnergyTableSize] = {
#include "Shading/OpenPbrEnergyTables/openpbr_ideal_dielectric_energy_complement_data.h"
};

static constexpr uint16_t IdealDielectricAverageEnergyComplement[
    EnergyTableSize * EnergyTableSize] = {
#include "Shading/OpenPbrEnergyTables/openpbr_ideal_dielectric_avg_energy_complement_data.h"
};

static constexpr uint16_t IdealDielectricReflectionRatio[
    EnergyTableSize * EnergyTableSize] = {
#include "Shading/OpenPbrEnergyTables/openpbr_ideal_dielectric_reflection_ratio_data.h"
};
